...
mod tests {
    ...
    fn box_placement(node: crate::state::Node, x: i64, y: i64, width: i64, height: i64) -> crate::layout::Placement {
    ...
    fn label_is_drawn_inside_the_box() {
        let placements = vec![
            box_placement(box_node(crate::state::PLAIN, crate::state::PLAIN, false), 0, 0, 5, 3),
